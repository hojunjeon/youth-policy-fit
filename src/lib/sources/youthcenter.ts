...
// 29(광주광역시)·46(전라남도)은 2026년 통합으로 12(전남광주통합특별시)로 흡수됐으나,
// 오래된 캐시/미갱신 응답이 통합 이전 코드를 계속 내려줄 수 있어 방어적으로 매핑해둔다.
const LEGACY_SIDO_MAP: Record<string, string> = {
  "42": "51", // 강원도 → 강원특별자치도
  "45": "52", // 전라북도 → 전북특별자치도
  "29": "12", // 광주광역시 → 전남광주통합특별시 (2026 통합, 방어적)
  "46": "12", // 전라남도 → 전남광주통합특별시 (2026 통합, 방어적)
};
